<template>
  <div id="app">
    <div class="opening">
      ...
      <p>
        本文使用內政部的「108年度全國宗教資訊寺廟分布圖」，搭配熱點分析（Hotspot
        Analysis）技術，分析台灣各主要信仰的地理分佈。地圖的顏色愈深，代表主祀該神祇的廟宇在該地區的廟宇佔比愈高。本文分析六大信仰：福德正神（土地公）、觀世音菩薩、媽祖（天上聖母）、釋迦牟尼、王爺／千歲及玄天上帝，找出這些信仰的熱區，並列出熱區的相關廟宇供參考。
      </p>
    </div>
    <Map />
    <div class="footnote">
